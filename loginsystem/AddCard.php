...
<style type="text/css">
body {background-image:url("image/background.png");background-repeat:no-repeat;background-attachment:fixed;
    background-position: top right;
    background-size: cover;}
header .head h1 {font-family:aguafina-script;text-align: center;color:#000000;}
...
<body>
  <header >
    <div class="head">
      ...
      <h1>RFID<br>
      Advanced Access List System</h1>
    </div>
    <a href="view.php">Access Log</a>
  </header>
        ...
        <form method="POST" action="user_insert.php">
          <label style="font-size:19px;">Options:</label>
            ...
            <button type="submit" name="set" style="border:none;background: none;" title="Select"><img src="image/set.png" width="30" ></button>
						<button type="submit" name="check" style="border:none;background: none;" title="Check"><img src="image/COVID.png" width="50" ></button>
        </form>
      </div>
        ...
        if (isset($_GET['error'])) {
          if ($_GET['error'] == "SQL_Error") {
             ...
             echo '<label style="color:red">This card does not exist!</label>';
					...
					else if ($_GET['error'] == "No_Need") {
						 echo '<lable style="color:red">This user does not need to be checked!</label>';
					}
        }
          ...
          if ($_GET['success'] == "registerd") {
            ...
            echo '<label style="color:green;">The Card has been selected</label>';
					...
					else if ($_GET['success'] == "Checked") {
						echo '<label style="color:green;">The user has been checked</label>';
					}
        }
      ?>
    </div>
...
<a href="https://www.yonsei.ac.kr/sc/"><img src="image/yonsei.png" style="float: right;right:5%;top:290px;position: absolute;"></a>
